...
Пример:
У моей дочки определен канал канал **Сохранения 27-50**. Людям с таким каналом свойственно проявление заботы об окружающих, а самый базовый способ заботы - это кормление.

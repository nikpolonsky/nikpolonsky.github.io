...
![Alt text](/assets/images/chart1.jpeg){: .img}
...
Всего их 36. Каждый канал имеет своё значение, но на базовом уровне он отражает определённую тему или талант, который проявляется в человеке.
